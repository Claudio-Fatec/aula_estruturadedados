...
# Atende uma pessoa 
atendido = fila_ubs.dequeue() #dequeue tira da fila
print(f"Foi atendido: {atendido}")
print(fila_ubs)

# Consulta quem será o próximo a ser atendido
proximo = fila_ubs.peek() # peek só lê o arquivo
print(f"{proximo} será o próximo a ser atendido")
print(fila_ubs) 

# Mais dua pessoas chegaram na fila
...
# Fila por estrita orde de chegada (não tem como furar a fila) também não conegue cancelar um registro.(caso o ultimo da fila desista
